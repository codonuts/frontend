...
class PdfReportService {
  ...
  static Future<Uint8List> generateInspectionPdf(
    ...
    try {
      final logoData = await rootBundle.load('assets/images/consumer_affairs_logo.jpg');
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.SizedBox(height: 6),
                  pw.Text(
                    'Exhibit A Identifier: EXA-${report.caseId} | SHA-256 Checksum: $sha256Digest',
                    style: pw.TextStyle(fontSize: 7.5, fontWeight: pw.FontWeight.bold, color: primaryNavy),
                  ),
                  ...
                  pw.Row(
                    ...
                    children: [
                      pw.Text(
                        'Geo-Coordinates: $gpsCoordinates | Device IMEI: 864320056789123',
                        style: const pw.TextStyle(fontSize: 7, color: PdfColors.grey800),
                      ),
                      pw.Text(
                        'Atomic Time: UTC(NPLI) CSIR-NPL ($istFormatted)',
                        style: const pw.TextStyle(fontSize: 7, color: PdfColors.grey800),
                      ),
                    ],
                  ),
                  pw.SizedBox(height: 3),
                  pw.Text(
                    'Cross-Registry Verification: GS1 Global Registry (MATCH) | FSSAI & Model Approval (VERIFIED) | Dual MRP Relabeling (CHECKED)',
                    style: pw.TextStyle(fontSize: 6.8, fontWeight: pw.FontWeight.bold, color: passGreen),
                  ),
                  pw.SizedBox(height: 3),
                  pw.Text(
                    'Legal Notice: This electronic document is generated under Section 15 & 18 of Legal Metrology Act, 2009. The cryptographic hash and hardware IMEI binding guarantee tamper-proof Section 65B evidentiary integrity for judicial proceedings.',
